...
if(isset($_GET["categorizr"])){
	$view = $_GET["categorizr"];
	// If categorizr=desktop set in your query string
	if ($view == "desktop")
	{
		$_SESSION[$category] = "desktop";
	} 
	// If categorizr=tablet set in your query string
	else if ($view == "tablet")
	{
	...
	// If categorizr=mobile set in your query string
	else if ($view == "mobile")
	{
